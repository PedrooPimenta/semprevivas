...
class TaxonForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        distribuicao_biomas_selecionados = self.cleaned_data.get('distribuicao_biomas')
        fitofisionomias_selecionados = self.cleaned_data.get('fitofisionomias')
        distribuicoes_formacoes_selecionados = self.cleaned_data.get('distribuicoes_formacoes')
        ...
        if distribuicao_biomas_selecionados:
            instance.distribuicao_biomas = json.dumps(distribuicao_biomas_selecionados)
        ...
        if distribuicoes_formacoes_selecionados:
            instance.distribuicoes_formacoes = json.dumps(distribuicoes_formacoes_selecionados)
