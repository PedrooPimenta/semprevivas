...
urlpatterns = [
    ...
    path('editar-especie/<uuid:especie_id>/', views.editar_especie, name='editar_especie'), 
    path('apagar-especie/<uuid:especie_id>/', views.apagar_especie, name='apagar_especie'),
